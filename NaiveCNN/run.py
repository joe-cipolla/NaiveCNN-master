...
if __name__ == '__main__':
    ...
    data_path = '/Users/joecipolla/Documents/Reference/Education/490-DL_Deep Learning/Week_6/' \
                'NaiveCNN-master/cifar-10-batches-py/'

    args = ['run.py', data_path, 100, 1000, 1, 10, 4]
    main(args)
